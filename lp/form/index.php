    ...
    <div class="container">
      ...
      <form action="./send.php" method="POST" id="applyForm" enctype="multipart/form-data">
        ...
        <div class="tab step2">
          ...
          <dl>
            <dt>
              <label for="province">ご住所</label>
            </dt>
            <dd>
              <div class="form_group">
                <div class="address_group">
                  <div class="required">
                    <select class="maxwidth200" id="province" name="province">
                      <option selected="selected" value="">▼以下から選択</option>
                  ...
                  <div class="required">
                    <input type="text" name="address" id="address" placeholder="※市町村と番地をご入力" required="">
                  </div>
                  <div>
                    <input type="text" name="building" id="building" placeholder="※建物名、部屋番号をご入力">
                  </div>
                </div>
              </div>
            </dd>
